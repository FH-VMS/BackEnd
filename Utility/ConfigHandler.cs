    ...
    public class ConfigHandler
    {
        ...
        public static string EhrFilePath
        {
            get
            {
                ...
                {
                    _ehrFilePath = System.Web.HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["EhrFilePath"] ?? "~/Files/EHR/");
                }
                return _ehrFilePath;
            }
        }
        ...
        public static string EhrFileRelativePath
        {
            get
            {
                ...
                {
                    _ehrFileRelativePath = new Control().ResolveUrl(ConfigurationManager.AppSettings["EhrFilePath"] ?? "~\\Files\\EHR\\");
                }
