...
namespace Utility
{
    public class FileHandler
    {
        ...
        public static bool WriteFile(string Path, string Name, string content)
        {
            try
            {
                string pathVal = HttpContext.Current.Request.PhysicalApplicationPath + Path;
        ...
        public static string ReadFile(string Path)
        {
            try
            {
                StreamReader sr = new StreamReader(HttpContext.Current.Request.PhysicalApplicationPath + Path, System.Text.Encoding.GetEncoding("utf-8"));
        ...
        public static void DeleteFile(string path)
        {
            try
            {
                string finalPath = HttpContext.Current.Request.PhysicalApplicationPath + path;
