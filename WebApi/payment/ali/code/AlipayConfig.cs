...
namespace Com.Alipay
{
    ...
    public class Config
    {
        ...
        public static string notify_url = "http://www.wangchaocctv.com/payment/ali/page/notify_url.aspx";

        // 页面跳转同步通知页面路径，需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
        public static string return_url = "http://www.wangchaocctv.com/payment/ali/page/return_url.aspx";
